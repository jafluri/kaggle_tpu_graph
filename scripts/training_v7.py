...
from tpu_graph.data import LayoutDatasetFinal as LayoutDataset
from tpu_graph.networks import TPUGraphNetworkV3
...
def train_network(rank, kwargs):
    ...
    network = TPUGraphNetworkV3(
        embedding_out=512,
        start_mlp_dims=[],
        message_network_dims=[512, 384, 256],
        final_mlp_dims=[256, 256, 256],
