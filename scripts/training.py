...
def train_tile_network(**kwargs):
    ...
    val_dataloader = val_dataset.get_dataloader(batch_size=128, shuffle=False, drop_last=False)
    ...
    test_dataloader = test_dataset.get_dataloader(batch_size=128, shuffle=False, drop_last=False)
